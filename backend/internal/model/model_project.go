...
//
// Status 为审核状态：pending 待审核、approved 已通过、rejected 已驳回。
// 历史动态（审核功能上线前发布）在迁移时统一置为 approved，保持公开展示不变。
type ProjectUpdate struct {
	...
	ReviewComment string     `gorm:"size:255" json:"reviewComment,omitempty"`
